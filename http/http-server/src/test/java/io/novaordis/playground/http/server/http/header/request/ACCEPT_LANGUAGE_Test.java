...
package io.novaordis.playground.http.server.http.header.request;
 ...
 * @since 1/6/17
 */
public class ACCEPT_LANGUAGE_Test extends HttpHeaderDefinitionTest {
    ...
    protected HttpHeaderDefinition getHttpHeaderDefinitionToTest() {
        ...
        return HttpRequestHeader.ACCEPT_LANGUAGE;
    }
